...
<html lang="en">
    ...
    <body class="" style="font-family: Arial; background-image: url('<?= site_url('assets/dist/img/library_image.jpg') ?>'); background-repeat: no-repeat; background-size: 100% 100%;">
                                ...
                                <div style="padding-top: 20%;">
                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                        <div class="card-header">
                                            <h3 class="text-center font-weight-light my-4" style="font-weight: bold;">PERPUSTAKAAN</h3>
                                        </div>
                                        <div class="card-body">
                                            <form action="" method="post" id="form-data">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                    <button type="submit" class="btn btn-warning" style="width: 100%; font-weight: bold; background-color: #fd7e14; color: white;">Login</button>
                                                </div>
                                            </form>
                                        </div>
